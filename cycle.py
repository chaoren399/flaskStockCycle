...
def index():
    ...
    df = pd.read_csv(CSV_FILE, dtype={"压力高度":'Int64',"大面数":'Int64',"最高板":'Int64',"连板数":'Int64',"大肉情绪":'Int64',"跌停数量":'Int64',"涨停数量":'Int64',"封板率":'Int64',"情绪值":'Float64',"涨停打开":'Int64'})
...
def edit(id):
    ...
    if request.method == 'POST':
        ...
        df.at[id, '备注2'] = request.form['备注2']  # 新增备注字段
